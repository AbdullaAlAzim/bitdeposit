...
test.describe(`Transfer test scenario`, () => {
  ...
  test("Withdraw By Mobile", async ({ page }) => {
    ...
    try {
      ...
      await page.screenshot({ path: 'transfer-step1.png' });

      // Step 2: Select bKash Personal
      await page.getByText('bKash Personal', { exact: true }).click();
      await page.waitForLoadState('networkidle', { timeout: 10000 });
      await page.screenshot({ path: 'transfer-step2.png' });
      ...
      await page.screenshot({ path: 'transfer-step3.png' });
      ...
      await page.waitForTimeout(1000);
      await page.screenshot({ path: 'transfer-step4.png' });
      ...
      await page.waitForTimeout(1000);
      await page.screenshot({ path: 'transfer-step5.png' });
      ...
      if (confirmCount === 0) {
        ...
        await page.screenshot({ path: 'confirm-button-missing.png' });
        throw new Error("❌ 'Yes' button not found after Cancel");
      }

      await confirmBtn.first().click({ force: true });
      await page.waitForTimeout(1000);
      await page.screenshot({ path: 'transfer-step6.png' });
      ...
      await page.screenshot({ path: 'transfer-step7.png' });

    } catch (error) {
      await page.screenshot({ path: 'transfer-error.png' });
